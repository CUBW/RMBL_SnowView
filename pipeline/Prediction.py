...
from Preprocessing import nn_preprocessing, rf_preprocessing
from Postprocessing import save_image, display_both
...
OUTPUT_DIRECTORY = "./predictions/" # change this directory if running Prediction.py
...
def full_pipeline(img_filepath, model_type, output_dir, verbose=False, **kwargs):
    """
...
if __name__ == '__main__':
    ...
    # run full pipeline
    full_pipeline(IMG_FILEPATH, 'RF', OUTPUT_DIRECTORY, verbose=True, width=1000)
