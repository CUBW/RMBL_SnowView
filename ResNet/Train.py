...
if __name__ == "__main__":
    ...
    resnet = resnet_model(img_height=640, img_width=640, img_channels=3)
    model, history = train_model(resnet, train_dataset, val_dataset, test_dataset, class_weights, epochs=50)
