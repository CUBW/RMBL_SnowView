...
def visualize_predictions(dataset, model, location=None, date=None, num_examples=3, fileDir=None):
    ...
    for i, (img, mask) in enumerate(samples):
        ...
        if fileDir:
            save_plot(plt, f'prediction_{i}.jpg', fileDir)
...
if __name__ == "__main__":
    ...
    model_path = os.path.abspath(os.path.join("ResNet", "2024-07-02-10-18", "Model_Data", "ResNet_2024-07-02-10-18.keras"))
    ...
    history_path = os.path.abspath(os.path.join("ResNet", "2024-07-02-10-18", "Model_Data", "history.json"))
    ...
    if history is not None:
        ...
        result_dir = os.path.join(model_name, "2024-07-02-10-18", "results")
        os.makedirs(result_dir, exist_ok=True)
        visualize_predictions(train_dataset, model , num_examples=3, fileDir=result_dir)