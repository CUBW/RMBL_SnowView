...
if __name__ == "__main__":
    ...
    model_path = os.path.abspath(os.path.join("DeepLab", "2024-06-26", "Model_Data", "DeepLab_2024-06-26.keras"))
    ...
    history_path = os.path.abspath(os.path.join("DeepLab", "2024-06-26", "Model_Data", "history.json"))
